            ...
            <article <?php post_class( 'project' ); ?>>
                ...
                <section class="section project-hero-grid">
                    <div class="section__inner project-hero-grid__inner">
                        ...
                        <div class="project-hero-grid__images" data-aos="fade-up">
                            <?php
                        ...
                        <aside class="project-hero-grid__sidebar" data-aos="fade-left">
                            <?php if ( $status_label ) : ?>
                                <p class="project-status-badge"><?php echo esc_html( $status_label ); ?></p>
                            <?php endif; ?>
                ...
                <section class="section">
                    <div class="section__inner project-content__inner" data-aos="fade-up">
