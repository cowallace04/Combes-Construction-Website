<?php
/**
 * Admin meta boxes for Projects, Team Members, Jobs, Bids, and Project Inquiries.
 */
...
function combes_core_add_meta_boxes() {
    ...
    // Bidding Opportunities (legacy CPT, still fully functional).
    add_meta_box(
        'combes_bid_details',
    ...
    // Project Inquiries (Build With Combes).
    add_meta_box(
...
/**
 * Project meta box UI.
 * Meta keys defined in register-project-meta.php
 */
...
function combes_core_save_project_meta_box( $post_id ) {
    ...
    if ( isset( $_POST['combes_project_display_order'] ) ) {
        $order = max( 0, intval( $_POST['combes_project_display_order'] ) );
...
function combes_core_render_job_meta_box( $post ) {
    ...
    <p>
        ...
        <input type="text" id="combes_job_department" name="combes_job_department"
               ...
               placeholder="Field Operations, Preconstruction, etc.">
    </p>
    ...
    <p>
        ...
        <textarea id="combes_job_benefits" name="combes_job_benefits"
                  rows="3" class="widefat"><?php echo esc_textarea( $benefits ); ?></textarea>
    </p>
    ...
    <p>
        ...
        <input type="text" id="combes_job_application_destination" name="combes_job_application_destination"
               ...
               placeholder="Email address, URL, or ATS link">
    </p>
    ...
    <p>
        <label for="combes_job_active">
            <input type="checkbox" id="combes_job_active" name="combes_job_active"
                   value="1" <?php checked( (bool) $active, true ); ?>>
            <strong>Active posting</strong>
        </label>
    </p>
...
function combes_core_save_job_meta_box( $post_id ) {
...
add_action( 'save_post_combes_job_opening', 'combes_core_save_job_meta_box' );

/* ========================================================================
 * BIDDING OPPORTUNITY META BOX (legacy CPT, separate from inquiries)
 * ===================================================================== */

/**
 * Bidding Opportunity meta box UI.
 * Uses combes_bid_* meta keys from register-bid-meta.php
 */
function combes_core_render_bid_meta_box( $post ) {
    ...
    <p>
        ...
        <textarea id="combes_bid_scope_packages" name="combes_bid_scope_packages"
                  rows="3" class="widefat"><?php echo esc_textarea( $scopes ); ?></textarea>
    </p>
    ...
    <p>
        ...
        <textarea id="combes_bid_document_links" name="combes_bid_document_links"
                  rows="3" class="widefat"><?php echo esc_textarea( $documents ); ?></textarea>
    </p>
    ...
    <p>
        <label for="combes_bid_open">
            <input type="checkbox" id="combes_bid_open" name="combes_bid_open"
                   value="1" <?php checked( (bool) $open, true ); ?>>
    ...
    <p>
        <label for="combes_bid_public">
            <input type="checkbox" id="combes_bid_public" name="combes_bid_public"
                   value="1" <?php checked( (bool) $public, true ); ?>>
            <strong>Public opportunity</strong>
        </label>
    </p>
...
/* ========================================================================
 * PROJECT INQUIRY META BOX (Build With Combes)
 * ===================================================================== */

/**
 * Project Inquiry meta box UI.
 * Uses combes_inquiry_* meta keys from register-inquiry-meta.php
 */
